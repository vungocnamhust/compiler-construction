...
typedef enum {
  ...
  SB_SEMICOLON, SB_MOD, SB_COLON, SB_PERIOD, SB_COMMA,
  SB_ASSIGN, SB_ASSIGN_MINUS, SB_ASSIGN_PLUS, SB_ASSIGN_TIMES, SB_ASSIGN_DIVIDE, SB_EQ, SB_NEQ, SB_LT, SB_LE, SB_GT, SB_GE,
